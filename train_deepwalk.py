...
# 添加运行环境路径
sys.path.append('src/deepwalk')

# 导入训练函数
from src.deepwalk.train import trainer
from src.utils import get_log_path, format_seconds

# 训练参数设置，可以手动改变 default 值
parser = argparse.ArgumentParser(
    description='DeepWalk 训练脚本',
    formatter_class=argparse.ArgumentDefaultsHelpFormatter
)
parser.add_argument('--data_path', type=str, default="cora", help='数据集路径, 如果是 cora、citeseer、pubmed,填写名称即可.')
...
if __name__ == '__main__':
    # 创建日志地址
    log_path, log_file = get_log_path('deepwalk')
